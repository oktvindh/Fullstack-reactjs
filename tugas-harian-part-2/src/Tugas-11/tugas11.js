...
const Tugas11 = () => {
    ...
    return (
        <>
            ...
            <br/>
            <h1 style={{textAlign: "center"}}>Daftar Harga Buku</h1>
            <br/>
            <table style={{width:"50%", border:"1px solid #aaa", margin:"auto", padding:"50px"}} id="customers">
            <thead>
            <tr>
                <th>No</th>
                <th>Nama</th>
            ...
            <br/>
            <form style={{width:"50%", border:"1px solid #aaa", margin:"auto", padding:"30px", marginBottom:"30px"}}>
                ...
                <input style={{float:"right"}} onChange={handleChange} value={input.beratTotal} name="beratTotal" type="number" required min={1000}/>
                <br/>
                <br/>
                <br/>
